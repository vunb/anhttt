...
angular.module($appname)
    .controller("AlgorithmController", ["$scope", "$timeout", "ExtendedEuclid", "PowerModulo", "GeneratePrimitiveNumber", "PrimeNumbers", function ($scope, $timeout, ExtendedEuclid, PowerModulo, GeneratePrimitiveNumber, PrimeNumbers) {
